...
struct op_flag
{
	...
	/* detail mode */
	int show_multi_column;	/* -C Force multi-column output; this is the default when output is to a terminal */
	int multi_col_across;		/* -x:  */
	...
	int show_human;			/* -h: causing the sizes to be reported in bytes displayed in a human readable format */
	int show_kbytes;		/* -k: causing the sizes to be reported in kilobytes */
	...
	*/
	...
	int Minode_length;
	int Mblk_length;
	int Mblk_length_kbytes;
	int Mblk_length_human;
	int Msize_length_human;
	int Msize_length_kbytes;
	int Max_name_posx;
	int Max_name_posy;
	int Max_name_length;
};
